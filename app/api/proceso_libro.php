...
if (isset($_GET['action'])) {
    ...
    if (isset($_SESSION['id_empleado'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'createact15b':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['points15b'])) {
                    if ($libros->setLibro($_POST['idlibro15b'])) {
                        if ($libros->setId($_POST['idcliente15b'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
            ...
            case 'createact16':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['points16'])) {
                    if ($libros->setLibro($_POST['idlibro16'])) {
                        if ($libros->setId($_POST['idcliente16'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
            ...
            case 'createact18':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['points18'])) {
                    if ($libros->setLibro($_POST['idlibro18'])) {
                        if ($libros->setId($_POST['idcliente18'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
            ...
            case 'createact18b':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['points18b'])) {
                    if ($libros->setLibro($_POST['idlibro18b'])) {
                        if ($libros->setId($_POST['idcliente18b'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
            ...
            case 'createact21':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['points21'])) {
                    if ($libros->setLibro($_POST['idlibro21'])) {
                        if ($libros->setId($_POST['idcliente21'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
            ...
            case 'createact22':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['points22'])) {
                    if ($libros->setLibro($_POST['idlibro22'])) {
                        if ($libros->setId($_POST['idcliente22'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
            ...
            case 'createact28':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['points28'])) {
                    if ($libros->setLibro($_POST['idlibro28'])) {
                        if ($libros->setId($_POST['idcliente28'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
            ...
            case 'createactA12U1L11':
                ...
                break;
            case 'createactA13U1L11':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['pointsA13U1L11'])) {
                    if ($libros->setLibro($_POST['idlibroA13U1L11'])) {
                        if ($libros->setId($_POST['idclienteA13U1L11'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
                ...
                break;
            case 'createactA14U1L11':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['pointsA14U1L11'])) {
                    if ($libros->setLibro($_POST['idlibroA14U1L11'])) {
                        if ($libros->setId($_POST['idclienteA14U1L11'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
                ...
                break;
            case 'createactA16U1L11':
                $_POST = $libros->validateForm($_POST);
                if ($libros->setPromedio($_POST['pointsA16U1L11'])) {
                    if ($libros->setLibro($_POST['idlibroA16U1L11'])) {
                        if ($libros->setId($_POST['idclienteA16U1L11'])) {
                            if ($libros->createRow()) {
                                $result['status'] = 1;
                                $result['message'] = 'success';
                            } else {
