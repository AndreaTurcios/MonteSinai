        ...
        <div id="p1" class="paper">
            <div class="front">
                <div id="f1" class="front-content">
                    <div>
                        <img src="../../resources/img/BOOKS/SecondGrade/UnitThree/44.PNG" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="back">
...
<script type="text/javascript" src="../../app/controllers/unidadtressegundogrado.js"></script>
