                    ...
                    <div class="container-fluid">
						...
						<div class="row">
                            <div class="col-6">
                                ...
                                <div class = oracion>
                                    <input type="checkbox" id="act16-cb3"><label for="act16-cb3">&nbsp;<strong>Do you want any cheese?</strong> Thanks but I don't want any more cheese</label><!-- correct -->
                                </div>
							</div>
                            <div class="col-6">
								<div class = oracion>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-6">
								<div class="col-12">
									<strong>III-Complete the questions using 'how much' and 'how many'</strong>
								</div>
							...
							<div class="col-6">
								<div class="col-12">
									<strong>VIII-How much versus How many</strong>
								</div>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-6">
								<div class="col-12">
									<strong>V-Can you explain the general rule in the relatio quality-price when choosing items?</strong>
								</div>
								...
								<div class="col-md-12">
									<select id="act25-q3">
										...
										<option value="3">Price is more important than quality</option>
									</select>
								</div>
							</div>
							<!-- pregunta6 -->
							<div class="col-6">
								<div class="col-12">
									<strong>VI-Why do you think that there is a need to promote the development of local industry?</strong>
								</div>
							...
							<div class="col-6">
								<div class="col-12">
									<strong>VII-Count and Non-count nouns</strong>
								</div>
							...
							<div class="col-6">
								<div class="col-12">
									<strong>VIII-Fill the gap with 'some' or 'any'</strong>
								</div>
								<br>
								<div class="col-md-12">
