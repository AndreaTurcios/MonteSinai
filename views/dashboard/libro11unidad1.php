...
<div id="ModalLibroDieciseis" class="modal fade" tabindex="-4">
    <!-- <div class="container-fluid"> -->
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8 align-items-center">
                                <!-- class="d-none" -->
                                <input type="text" class="d-none" id="pointsA16U1L11" name="pointsA16U1L11">
                                <input type="text" class="d-none" id="idlibroA16U1L11" name="idlibroA16U1L11">
                                <input type="text" class="d-none" id="idclienteA16U1L11" name="idclienteA16U1L11">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <h5>What is the name of the famous speech by Martin Luther King, Jr?</h5>
                                <select name="sentences" id="g1">
                                    <option value="1">I have a desire</option>
                                    <option value="2">Respect the black people</option>
                                    <option value="3">I have a dream</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <h5>How many people heard the speech?</h5>
                                <select name="sentences" id="g2">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <h5>When was the date of the speech?</h5>
                                <select name="sentences" id="g3">
                                    <option value="1">February 28, 1962</option>
                                    <option value="2">December 17, 1960</option>
                                    <option value="3">August 28, 1963</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <h5>What was the message of the speech?</h5>
                                <select name="sentences" id="g4">
                                    <option value="1">Black and white people</option>
                                    <option value="2">Everyone coexist harmoniously as equals</option>
                                    <option value="3">The white people loves black people</option>
                                </select>
                            </div>
                        </div>
                    </div>
