...
<div class="modal fade" id="ModalUnit1Act49" tabindex="-5">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Complete the Activity</h5>
			...
			<form method="post" id="unit1-act49">
				<div class="modal-body">
					<div class="container-fluid">
						<div class="form-group">
							<!-- columna -->
							<div class="container-fluid">
								<div class="row align-items-center">
									<div class="row mb-4">
										<div class="col align-items-center">
											<p class="fs-5 fw-bold">Write according to</p>
											<input type="text" class="d-none" id="points49" name="points">
											<input type="text" class="d-none" id="idcliente49" name="idcliente">
											<input type="text" class="d-none" id="idlibro49" name="idlibro">
										</div>
									</div>
									<div class="row row-cols-2">
										<div class="col"><img src="../../resources/img/BOOKS/FourthGrade/UnitOne/activities/57-1.jpg" class="img-fluid"></div>
										<div class="col"><img src="../../resources/img/BOOKS/FourthGrade/UnitOne/activities/57-2.jpg" class="img-fluid"></div>
									</div>
									<div class="row">
										<div class="col">
											<div class="row mb-3" style="border: 2px dotted cyan">
												<p>Write dining room's furnitures and household appliances:</p>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-29" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-30" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-31" class="form-control">
												</div>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-32" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-33" class="form-control">
												</div>
											</div>
											<div class="row mb-3" style="border: 2px dotted cyan">
												<p>Write bathroom's furnitures and household appliances:</p>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-34" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-35" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-36" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-37" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-41" class="form-control">
												</div>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-38" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-39" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-40" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-42" class="form-control">
												</div>
											</div>
											<div class="row mb-3" style="border: 2px dotted cyan">
												<p>Write bedroom's furnitures and household appliances:</p>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-1" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-2" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-3" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-4" class="form-control">
												</div>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-5" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-6" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-7" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-8" class="form-control">
												</div>
											</div>
											<div class="row mb-3" style="border: 2px dotted cyan">
												<p>Write living room's furnitures and household appliances:</p>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-9" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-10" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-11" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-12" class="form-control">
												</div>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-13" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-14" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-15" class="form-control">
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col">
											<div class="row mb-3" style="border: 2px dotted cyan">
												<p>Write kitchen's furnitures and household appliances:</p>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-16" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-17" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-18" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-19" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-20" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-21" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-22" class="form-control">
												</div>
												<div class="col-6">
													<input type="text" autocomplete="off" id="input-act49-23" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-24" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-25" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-26" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-27" class="form-control">
													<input type="text" autocomplete="off" id="input-act49-28" class="form-control">
												</div>
											</div>
										</div>
									</div>
...
<div class="modal fade" id="ModalUnit1Act50" tabindex="-5">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Complete the Activity</h5>
			...
			<form method="post" id="unit1-act50">
				<div class="modal-body">
					<div class="container-fluid">
						<div class="form-group">
							<!-- columna -->
							<div class="container-fluid">
								<div class="row align-items-center">
									<div class="row mb-4">
										<div class="col align-items-center">
											<p class="fs-5 fw-bold">Write the missing words.</p>
											<input type="text" class="d-none" id="points50" name="points">
											<input type="text" class="d-none" id="idcliente50" name="idcliente">
											<input type="text" class="d-none" id="idlibro50" name="idlibro">
										</div>
									</div>
									<div class="row ">
										<div class="col">
											<p class="text-justify" style="display: inline;">
											It is because a </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="11" id="input-act50-1" style="width:auto; display: inline-block;" >
											<br>
											<br>
											<p class="text-justify" style="display: inline;">
											Of the </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="8" id="input-act50-2" style="width:auto; display: inline-block;" >
											<p class="text-justify" style="display: inline;"> has </p>
												<input type="text" class="form-control" autocomplete="off" maxlength="4" id="input-act50-3" style="width:auto; display: inline-block;" >
											<p class="text-justify" style="display:inline;">,</p>
											<br>
											<br>
											<p class="text-justify" style="display: inline;">
											in the </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="4" id="input-act50-4" style="width:auto; display: inline-block;" >
											<p class="text-justify" style="display: inline;"> of a </p>
												<input type="text" class="form-control" autocomplete="off" maxlength="4" id="input-act50-5" style="width:auto; display: inline-block;" >
											<br>
											<br>
											<p class="text-justify" style="display: inline;">
											his morning </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="4" id="input-act50-6" style="width:auto; display: inline-block;" >
											<p class="text-justify" style="display: inline;">,</p>
											<br>
											<br>
											<p class="text-justify" style="display: inline;">
											that the </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="10" id="input-act50-7" style="width:auto; display: inline-block;" >
											<br>
											<br>
											<p class="text-justify" style="display: inline;">
											with </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="5" id="input-act50-8" style="width:auto; display: inline-block;" >
											<p class="text-justify" style="display: inline;"> in the </p>
												<input type="text" class="form-control" autocomplete="off" maxlength="5" id="input-act50-9" style="width:auto; display: inline-block;" >
											<br>
											<br>
											<p class="text-justify" style="display: inline;">
											as if it </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="3" id="input-act50-10" style="width:auto; display: inline-block;" >
											<br>
											<br>
											<p class="text-justify" style="display: inline;">
											a musical </p> 
												<input type="text" class="form-control" autocomplete="off" maxlength="5" id="input-act50-11" style="width:auto; display: inline-block;" >
											<p class="text-justify" style="display: inline;">.</p>
										</div>
									</div>
								</div>
...
<div class="modal fade" id="ModalUnit1Act51" tabindex="-5">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Complete the Activity</h5>
			...
			<form method="post" id="unit1-act51">
				<div class="modal-body">
					<div class="container-fluid">
						<div class="form-group">
							<!-- columna -->
							<div class="container-fluid">
								<div class="row align-items-center">
									...
									<div class="row">
										<img src="../../resources/img/BOOKS/FourthGrade/UnitOne/activities/59-1.jpg" class="img-fluid">
									</div>
									<style type="text/css">
										.cell {
									...
									<div class="row row-cols-2 justify-content-center">
										<div class="col">
											<table style="width:75%;" class="table-cross51l4">
												<tr>
													<!-- 1 -->
													<td class="cell">
										...
										<div class="col">
											<img src="../../resources/img/BOOKS/FourthGrade/UnitOne/activities/59-2.jpg" class="img-fluid">
										</div>
									</div>
								</div>
							</div>
...
<div id="ModalUnit1Audio1" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio1">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track01.mp3" type="audio/mp3">
...
<div id="ModalUnit1Audio2" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio2">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track02.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio3" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio3">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track03.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio4" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio4">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track04.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio5" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio5">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track05.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio6" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio6">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track06.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio7" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio7">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track07.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio8" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio8">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track08.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio9" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio9">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track09.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio10" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio10">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track10.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio11" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio11">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track11.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio12" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio12">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track12.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio13" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio13">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track13.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio14" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio14">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track14.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio15" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio15">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track15.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio16" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio16">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track16.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio17" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio17">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track17.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio19" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio19">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track19.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio20" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio20">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track20.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio21" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio21">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track21.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio22" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio22">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track22.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio23" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio23">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track23.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio24" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio24">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track24.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
...
<div id="ModalUnit1Audio25" class="modal fade" tabindex="-2">	
    <div class="modal-dialog modal-xl">
		<div class="modal-content">
			<form class="form d-flex justify-content-center" autocomplete="off" method="post" novalidate id="unit1-audio25">			
				<audio controls style="margin-top: 10px; margin-bottom: 10px;">
					<source src="../../resources/audio/ingles_cuarto/UnitOne/Track25.mp3" type="audio/mp3">
					Tu navegador no soporta audio HTML5.
				</audio> 								
			</form>
        </div>
