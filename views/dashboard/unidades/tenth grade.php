...
Dashboard_Page::headerTemplate('Book 10');
?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center" id="Titulo1">
                <h1 class="center">TENTH BOOK: <br />Time to learn english</h1>
                <br />
                <h3 class="center">Tenth grade</h3>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <span style="font-weight: bold;text-transform: uppercase; font-size: 17px;">Meeting Salvadorean Personalities</span>
                    <div style="
                        font-size: 18px;">- Topic 1
                    </div>
