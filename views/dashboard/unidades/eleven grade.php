    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center" id="Titulo1">
                <h1 class="center">ELEVEN BOOK: <br/>Time to learn english</h1>
                <br />
                <h3 class="center">Eleven grade</h3>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <span style="font-weight: bold;text-transform: uppercase; font-size: 17px;">Meeting famous people around the world</span>
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <span style="font-weight: bold;text-transform: uppercase; font-size: 17px;">The world</span>
                    <a class="btn btn-primary" href="../libro1Unidad1t.php" role="button" style="margin-top: 5px; width: 100%; background-color: #c92920; border-color: #c92920; " >View contents</a>
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <span style="font-weight: bold;text-transform: uppercase; font-size: 17px;">Customs around the world</span>
                    <a class="btn btn-primary" href="../libro1Unidad1t.php" role="button" style="margin-top: 5px; width: 100%; background-color: #c92920; border-color: #c92920; " >View contents</a>
                    <a class="btn btn-primary" href="../libro1Unidad1t.php" role="button" style="margin-top: 5px; width: 100%; background-color: #2A262B; border-color: #2A262B; " >Enter</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <span style="font-weight: bold;text-transform: uppercase; font-size: 17px;">International tourism</span>
                    <a class="btn btn-primary" href="../libro1Unidad1t.php" role="button" style="margin-top: 5px; width: 100%; background-color: #c92920; border-color: #c92920; " >View contents</a>
                    <a class="btn btn-primary" href="../libro1Unidad1t.php" role="button" style="margin-top: 5px; width: 100%; background-color: #2A262B; border-color: #2A262B; " >Enter</a>
                </div>
            </div>
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <span style="font-weight: bold;text-transform: uppercase; font-size: 17px;">The enviroment around the world</span>
                    <a class="btn btn-primary" href="../libro1Unidad1t.php" role="button" style="margin-top: 5px; width: 100%; background-color: #c92920; border-color: #c92920; " >View contents</a>
                    <a class="btn btn-primary" href="../libro1Unidad1t.php" role="button" style="margin-top: 5px; width: 100%; background-color: #2A262B; border-color: #2A262B; " >Enter</a>
                </div>
            </div>
