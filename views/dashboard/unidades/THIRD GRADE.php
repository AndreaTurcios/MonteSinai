        ...
        <div class="row">
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <a class="btn btn-primary" href="../libro3unidad2.php" role="button" style="width: 100%; background-color: #2A262B; border-color: #2A262B; " >Enter</a>
                </div>
            </div>
            ...
            <div class="col-sm-4" style=" padding: 10px;">
                <div style="background-color: #E4E4E4; border-radius: 10px; padding: 10px;">
                    ...
                    <a class="btn btn-primary" href="../libro3unidad3.php" role="button" style="width: 100%; background-color: #2A262B; border-color: #2A262B; " >Enter</a>
                </div>
            </div>
        </div>
    </div>
