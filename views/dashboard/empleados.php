  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 text-center" id="Titulo1">
        ...
        <h2 class="center">Gestión de empleados</h2>
      </div>
    </div>
    <br>
                    ...
                    <div class="modal-body">
                      <div class="container">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="nombre_emp" name="nombre_emp" placeholder="Nombre empleado" pattern="[a-zA-ZñÑáÁéÉíÍóÓúÚ\s]{1,50}" required minlength="3" maxlength="50" autocomplete="off" />
                        </div>
                        <div class="form-group">
                          <label for="apellido_emp">Apellido empleado:</label>
                          <input class="form-control" id="apellido_emp" type="text" name="apellido_emp" placeholder="Apellido empleado" pattern="[a-zA-ZñÑáÁéÉíÍóÓúÚ\s]{1,50}" required minlength="3" maxlength="50" autocomplete="off" />
                        </div>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="telefono_emp" name="telefono_emp" autocomplete="off" placeholder="0000-0000" pattern="[2,6,7]{1}[0-9]{3}[-][0-9]{4}" required minlength="9" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                        </div>

                        <div class="form-group">
                          <label for="direccion_emp">Direccion:</label>
                          <input class="form-control" id="direccion_emp" type="text" name="direccion_emp" placeholder="Direccion" size="30" required minlength="3" maxlength="50" autocomplete="off" />
                        </div>

                        <div class="form-group">
                          <label for="correo_emp">Correo:</label>
                          <input class="form-control" id="correo_emp" type="email" name="correo_emp" placeholder="Correo" size="30" required minlength="3" maxlength="50" autocomplete="off" />
                        </div>

                        <div class="form-group">
                          <label for="nombre_usuario">Usuario:</label>
                          <input type="text" class="form-control" id="nombre_usuario" name="nombre_usuario" autocomplete="off" placeholder="Usuario" required />
                        </div>

                        <div class="form-group">
                          <label for="clave_emp">Clave:</label>
                          <input type="password" class="form-control" id="clave_emp" name="clave_emp" autocomplete="off" placeholder="Clave" required />
                          <div class="campo">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control" id="claveconf" name="claveconf" autocomplete="off" placeholder="Confirmar clave:" required />
                          <div class="campo1">
                            <div class="form-group d-none">
        ...
        <form id="update-form" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" autocomplete="off" id="nombre_emp2" name="nombre_emp2" placeholder="Nombre empleado" pattern="[a-zA-ZñÑáÁéÉíÍóÓúÚ\s]{1,50}" required minlength="3" maxlength="50" />
            </div>
            <div class="form-group">
              <label for="apellido_emp2">Apellido empleado</label>
              <input class="form-control" id="apellido_emp2" autocomplete="off" type="text" name="apellido_emp2" placeholder="Apellido empleado" pattern="[a-zA-ZñÑáÁéÉíÍóÓúÚ\s]{1,50}" required minlength="3" maxlength="50" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="direccion_emp">Direccion:</label>
              <input class="form-control" id="direccion_emp2" type="text" name="direccion_emp2" placeholder="Direccion" size="30" required minlength="3" maxlength="50" autocomplete="off" />
            </div>

            <div class="form-group">
              <label for="correo_emp2">Correo:</label>
              <input class="form-control" id="correo_emp2" type="email" name="correo_emp2" placeholder="Correo" size="30" required minlength="3" maxlength="50" autocomplete="off" />
            </div>
