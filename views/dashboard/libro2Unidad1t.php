...
<div id="ModalLibroDos14" class="modal fade" tabindex="-2">
	...
	<div class="modal-dialog modal-xl">
		...
		<body class="body">
			...
			<form method="post" id="game-14">
				...
				<header class="header wrapper">
           			 <p class="text" text-align: center>Write the correct number:</p>
    			</header>
				<main class="main">
            <dialog class="dialog">
        ...
        <!-- Scripts -->
		<script src="../../app/controllers/BookTwoUnitOne/assets/polyfill/dialog-polyfill.js" type="module"></script>
