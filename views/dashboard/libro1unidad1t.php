...
<body style="background-image: url(../../resources/img/BOOKS/back.jpg);">
	...
	<div class="modal fade" id="ModalLibroTres" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
	...
	<div id="ModalLibroUno" class="modal fade" tabindex="-2" role="dialog">
